...
plot(regfit.adjr2, xlab = "Number of features", ylab = "Adjusted R^2", main = "Adjusted R^2 vs Number of features")
...
```{r}
plot(val.errors, xlab = "Number of features", ylab = "CV Error", main = "CV Error vs Number of features")
```
...
mean.cv.errors
par(mfrow = c(1,1))
plot(mean.cv.errors, type= "b", ylab = "CV Error", xlab = "Number of features", main = "CV Error vs number of best subset Features")
```
```{r}
...
par(mfrow = c(1,1))
plot(1:nFeatures, mean.cv.errors, xlab = "mtry", ylab = "CV Error", main = "5-Fold CV for Random Forest mtry")
...
best_mtry = 18
par(mfrow = c(1,1))
plot(num_tree, mean.cv.errors, xlab = "ntree", ylab = "CV Error", main = "5-Fold CV for Random Forest ntree with mtry = 18")
